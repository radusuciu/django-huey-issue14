"""
Django settings for issue14 project.
...
SECRET_KEY = 'django-insecure-400gumac=sud(a2x4zkduo2krz8xg9u5=cg*3sq3e8onh^!ly&'
...
WSGI_APPLICATION = 'issue14.wsgi.application'
